...
export function MobileCtaBar() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-md rounded-2xl border border-border bg-background/95 p-3 shadow-[0_-16px_40px_rgba(0,0,0,0.22)] backdrop-blur-xl">
        <div className="mb-3 flex items-center justify-between gap-3 text-xs">
          <span className="font-semibold text-foreground">{siteContent.brand.workingLabel}</span>
          <span className="text-muted-foreground">Бронь подтверждаем в WhatsApp</span>
        </div>
        ...
        <div className="grid grid-cols-[1fr_auto] gap-2">
          ...
          <Button asChild variant="outline" className="h-12 rounded-xl border-border bg-card px-4">
